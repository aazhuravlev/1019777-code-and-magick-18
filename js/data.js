...
(function () {
  ...
  var getWizards = function (quantity) {
    ...
    for (var i = 0; i < quantity; i++) {
      wizards.push({
        name: window.utils.spliceRandomItem(wizardNames) + ' ' + window.utils.spliceRandomItem(wizardSurnames),
        coatColor: window.utils.spliceRandomItem(coatColors),
        eyesColor: window.utils.spliceRandomItem(eyesColors)
      });
    }
    return wizards;
  };
